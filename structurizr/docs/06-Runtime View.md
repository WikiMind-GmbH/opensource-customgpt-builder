...
The client uploads a document and gets a response message as soon as the file has been saved to the files system. The background task which will process the documents, is queued before sending the response

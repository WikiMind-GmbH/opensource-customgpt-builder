...
from src.interface.http.mappers_data_and_exceptions.chat.retrieve_relevant_doc_snippets_port import (
    register_exception_handlers_retrieve_relevant_doc_snippets_port,
)
...
from src.interface.http.mappers_data_and_exceptions.knowledge.ports.embedding_generator_port_exceptions import (
    register_exception_handlers_embedding_generator_port,
)
...
from src.interface.http.mappers_data_and_exceptions.knowledge.ports.pre_process_text_likes_port_exceptions import (
    register_query_exception_handlers_pre_processing_port,
)
...
def register_all_handlers(app: FastAPI):
    ...
    register_exception_handlers_retrieve_relevant_doc_snippets_port(app)
